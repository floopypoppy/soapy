...
# Initialisation routines
    ...
    def frame(self, scrns, phase_correction=None, read=True, iMatFrame=False):
       ...
       #If iMatFrame, turn off unwanted effects
        ...
        # if geometric proporgation, self.los.phase_screens[i] would be calculated as interpolated sim.scrns[i] according to
        # GSPostion, GSheight and layerheight. self.los.phase is the sum of self.los.phase_screens[all]. self.los.EField is 
        # exp(j*self.los.phase)
